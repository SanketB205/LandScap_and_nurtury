  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-nature-50/30">
        ...
        <p className="text-primary-950 font-display italic text-xl">Loading story data...</p>
      </div>
    )
  }
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex items-center gap-8 mb-12">
           ...
           <div>
              ...
              <h1 className="text-5xl font-display font-black text-primary-950">Edit <span className="text-emerald-600">Story</span></h1>
           </div>
        </div>
